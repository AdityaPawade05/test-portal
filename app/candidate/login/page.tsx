      ...
      <div className="w-full max-w-sm">
        <div className="mb-8 flex flex-col items-center gap-3 text-center">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500">Sign in to view your test invitations</p>
          </div>
        </div>
        ...
        <p className="mt-6 text-center text-sm text-slate-500">
          ...
          <Link href="/candidate/register" className="font-medium text-indigo-600 hover:text-indigo-700">
            Create one
          </Link>
        </p>
      </div>
